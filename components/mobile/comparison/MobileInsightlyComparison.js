...
export class MobileInsightlyComparison extends Component {
  // renderBlockTable = () => {
  //   return (
  ...
  //         <img
  //           src={"/img/mobile/comparison/insightly.svg"}
  //           alt="mobile Insightly"
...
export default MobileInsightlyComparison;
