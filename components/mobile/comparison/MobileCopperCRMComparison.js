...
const mobileList2 = [
  "Copper is a popular CRM tool and is quite lightweight but it has serious limitations due to being available only for Gmail users.",
...
export class MobileCopperCRMComparison extends Component {
  // renderBlockTable = () => {
  //   return (
  ...
  //         <img
  //           src={"/img/mobile/comparison/copper.svg"}
  //           alt="mobile Copper CRM"
  //           className="mobile-zendesk-img"
  //         />
  //         <h5 className="mobile-comparison-dominate-text mobile-comparison-dominate-text--2">
  //           Copper CRM
  //         </h5>
  //       </div>
  //     </div>
  ...
  renderBlockPara = () => {
    return (
      <div className="mobile-comparison-para-section">
        ...
        <br />
        <p className="mobile-comparison-para">
          Copper CRM is a gmail-native CRM tool that is deeply integrated and
          almost lives inside gmail. It is lightweight and similar to Nimble CRM
          and helps salespeople keep track of important details such as
          meetings, followups and other task based reminders.
        </p>
      </div>
    );
  };
  ...
  renderBlockConclusion = () => {
    return (
      <div className="comparison-conclusion-section">
        ...
        <img
          src={"./mobile-dark-theme/comparison/conclusion.png"}
...
export default MobileCopperCRMComparison;
