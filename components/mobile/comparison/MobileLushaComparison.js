...
export class MobileLushaComparison extends Component {
  // renderBlockTable = () => {
  //   return (
  ...
  //         <img
  //           src={"/img/mobile/comparison/lusha.svg"}
  //           alt="mobile Lusha"
  //           className="mobile-zendesk-img"
  //         />
  //         <h5 className="mobile-comparison-dominate-text ">Lusha</h5>
  //       </div>
  //     </div>
  //   );
  // };
    ...
    return (
      <div className="mobile-comparison-para-section">
        ...
        <p className="mobile-comparison-para">
          ...
          verification, email validation to imrpoove the quality of a reachout.
        </p>
      </div>
    );
  };
      ...
      <div className="mobile-background-color">
        ...
        <div className="comparison-section row justify-content-start align-items-center mx-0">
          ...
          <div className="comparison-text-section">
            ...
            <h5 className="mobile-comparison-subtitle">Dominate Vs Lusha</h5>
          </div>
        </div>
...
export default MobileLushaComparison;
