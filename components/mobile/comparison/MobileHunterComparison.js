...
export class MobileHunterComparison extends Component {
  // renderBlockTable = () => {
  //   return (
  ...
  //         <img
  //           src={"/img/mobile/comparison/hunter.svg"}
  //           alt="mobile Hunter"
    ...
    return (
      <div className="mobile-comparison-para-section">
        ...
        <p className="mobile-comparison-para">
          ...
          validated and freshly updated and enables salespeople and marketers to
          have a more personalized conversation with their prospects.
        </p>
      </div>
    );
  };
...
export default MobileHunterComparison;
