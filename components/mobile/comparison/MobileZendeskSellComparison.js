...
const mobileList2 = [
  "Zendesk Sell has various features to help track leads and deals, thereby making the job of salespeople easier.",
...
export class MobileZendeskSellComparison extends Component {
  // renderBlockTable = () => {
  //   return (
  ...
  //         <img
  //           src={"/img/mobile/comparison/zendesk.png"}
  //           alt="mobile zendesk"
  ...
  renderBlockPara = () => {
    return (
      <div className="mobile-comparison-para-section">
        ...
        <br />
        <p className="mobile-comparison-para">
          Zendesk Sell is a feature-rich traditional CRM that provides
          salespeople with features such as tracking leads, deals and emails
          along with various integrations to make their job easier.
        </p>
      </div>
    );
  };
...
export default MobileZendeskSellComparison;
