...
const mobileList2 = [
  "Wiza is primarily a reach out list builder exclusively working with linkedin sales navigator.",
...
export class MobileWizaComparison extends Component {
  // renderBlockTable = () => {
  //   return (
  ...
  //         <img
  //           src={"/img/mobile/comparison/wiza.svg"}
  //           alt="mobile wiza"
  //           className="mobile-zendesk-img"
  //         />
  //         <h5 className="mobile-comparison-dominate-text">Wiza</h5>
  //       </div>
  //     </div>
  //   );
  // };
  ...
  renderBlockPara = () => {
    return (
      <div className="mobile-comparison-para-section">
        ...
        <br />
        <p className="mobile-comparison-para">
          Wiza is an email extraction tool specifically for the linkedin sales
          navigator enabling sales people to turn linkedin searches into
          verified emails for outreach campaigns making for a seamless
          experience with the help of a google chrome extension to work
          exclusively with linkedin sales navigator.
        </p>
      </div>
    );
  };
      ...
      <div className="mobile-background-color">
        ...
        <div className="comparison-section row justify-content-start align-items-center mx-0">
          ...
          <div className="comparison-text-section">
            ...
            <h5 className="mobile-comparison-subtitle">Dominate Vs Wiza</h5>
          </div>{" "}
        </div>
...
export default MobileWizaComparison;
