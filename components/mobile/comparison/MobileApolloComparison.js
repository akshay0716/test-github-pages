...
export class MobileApolloComparison extends Component {
  // renderBlockTable = () => {
  //   return (
  ...
  //         <img
  //           src={"/img/mobile/comparison/apollo.svg"}
  //           alt="mobile apollo"
  //           className="mobile-zendesk-img"
  //         />
  //         <h5 className="mobile-comparison-dominate-text ">Apollo</h5>
  //       </div>
  //     </div>
  //   );
  // };
...
export default MobileApolloComparison;
