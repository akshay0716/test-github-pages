...
export class MobilePipedriverComparison extends Component {
  // renderBlockTable = () => {
  //   return (
  ...
  //         <img
  //           src={"/img/mobile/comparison/pipe.svg"}
  //           alt="mobile Pipedrive"
  ...
  renderBlockPara = () => {
    return (
      <div className="mobile-comparison-para-section">
        ...
        <br />
        <p className="mobile-comparison-para">
          Pipedrive is a traditional CRM that enables users to create their own
          deal pipelines and effectively track deals along with the ability to
          create automated workflows to reduce manual tasks for salespeople.
        </p>
      </div>
    );
  };
...
export default MobilePipedriverComparison;
