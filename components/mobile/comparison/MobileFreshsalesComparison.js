...
const mobileList2 = [
  "Freshsales is a traditional but feature-rich CRM and is the market leader when it comes to CRMs.",
...
export class MobileFreshsalesComparison extends Component {
  // renderBlockTable = () => {
  //   return (
  ...
  //         <img
  //           src={"/img/mobile/comparison/freshsales.svg"}
  //           alt="mobile Freshsales"
  ...
  renderBlockPara = () => {
    return (
      <div className="mobile-comparison-para-section">
        ...
        <br />
        <p className="mobile-comparison-para">
          Freshsales is an industry leading traditional CRM product meant for
          enterprises and medium sized businesses. It is feature rich and has
          all the abilities of a CRM - track leads, deals, relationships and
...
export default MobileFreshsalesComparison;
