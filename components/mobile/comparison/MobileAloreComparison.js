...
export class MobileAloreComparison extends Component {
  // renderBlockTable = () => {
  //   return (
  ...
  //         <img
  //           src={"/img/mobile/comparison/alore.svg"}
  //           alt="mobile Alore.IO"
  ...
  renderBlockPara = () => {
    return (
      <div className="mobile-comparison-para-section">
        ...
        <br />
        <p className="mobile-comparison-para">
          Alore.IO consolidates growth tech stack and offers features needed to
          run growth functions at scale. It consists of email automation, sales
          list building, rule based flow builder, team performance and sales
      ...
      <div className="mobile-background-color">
        ...
        <div className="comparison-section row justify-content-start align-items-center mx-0">
          ...
          <div className="comparison-text-section">
            ...
            <h5 className="mobile-comparison-subtitle">Dominate Vs Alore.IO</h5>
          </div>
        </div>
...
export default MobileAloreComparison;
