...
const mobileList2 = [
  "Zoho CRM is a traditional but feature-rich CRM and is the market leader when it comes to CRMs.",
...
export class MobileZohoComparison extends Component {
  // renderBlockTable = () => {
  //   return (
  ...
  //         <img
  //           src={"/img/mobile/comparison/zoho.svg"}
  //           alt="mobile zoho"
  ...
  renderBlockPara = () => {
    return (
      <div className="mobile-comparison-para-section">
        ...
        <br />
        <p className="mobile-comparison-para">
          Zoho is an industry leading traditional CRM product meant for
          enterprises. It is feature rich and has all the abilities of a CRM -
          track leads, deals, relationships and analyze sales data in real-time.
        </p>
      </div>
    );
  };
      ...
      <div className="mobile-background-color">
        ...
        <div className="comparison-section row justify-content-start align-items-center mx-0">
          ...
          <div className="comparison-text-section">
            ...
            <h5 className="mobile-comparison-subtitle">Dominate Vs Zoho CRM</h5>
          </div>
        </div>{" "}
...
export default MobileZohoComparison;
