...
const mobileList2 = [
  "Clari is a CRM tool with data enrichment and activity intelligence features.",
  "It enables sales people to gather more information about their prospects and track leads and deals.",
  "Dominate on the other hand, adds much more capability in terms of data enrichment by providing intent based leads.",
  "Dominate also has prospecting abilities enabling sales people to not only track leads but also generate them by building lists with the help of email extractors.",
];

export class MobileClariComparison extends Component {
  // renderBlockTable = () => {
  //   return (
  ...
  //         <img
  //           src={"/img/mobile/comparison/clari.svg"}
  //           alt="mobile Clari"
  //           className="mobile-zendesk-img"
  //         />
  //         <h5 className="mobile-comparison-dominate-text">Clari</h5>
  //       </div>
  //     </div>
  //   );
  // };
  ...
  renderBlockPara = () => {
    return (
      <div className="mobile-comparison-para-section">
        ...
        <br />
        <p className="mobile-comparison-para">
          Clari is a revenue forecasting, activity intelligence and pipeline
          management tool for B2b sales teams. It is an intelligent CRM that
          saves effort and hours for the salespeople by enabling them to
          recognize risk and act on opportunity with the help of real-time
          revenue operations.
        </p>
      </div>
    );
      ...
      <div className="mobile-background-color">
        ...
        <div className="comparison-section row justify-content-start align-items-center mx-0">
          ...
          <div className="comparison-text-section">
            ...
            <h5 className="mobile-comparison-subtitle">Dominate Vs Clari</h5>
          </div>
        </div>{" "}
...
export default MobileClariComparison;
