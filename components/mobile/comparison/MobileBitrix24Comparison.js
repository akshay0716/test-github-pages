...
export class MobileBitrix24Comparison extends Component {
  // renderBlockTable = () => {
  //   return (
  ...
  //         <img
  //           src={"/img/mobile/comparison/bitrix.svg"}
  //           alt="mobile bitrix"
    ...
    return (
      <div className="mobile-comparison-para-section">
        ...
        <p className="mobile-comparison-para">
          ...
          enterprises and medium sized firms. It is feature rich and has all the
          abilities of a CRM - track leads, deals, relationships and analyze
      ...
      <div className="mobile-background-color">
        ...
        <div className="comparison-section row justify-content-start align-items-center mx-0">
          ...
          <div className="comparison-text-section">
            ...
            <h5 className="mobile-comparison-subtitle">Dominate Vs Bitrix24</h5>
          </div>
        </div>{" "}
...
export default MobileBitrix24Comparison;
