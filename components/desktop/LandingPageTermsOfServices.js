...
const LandingPageTermsOfServices = () => {
  /*===========================================
                renderBlockOne
  ============================================*/
    ...
    return (
      <div className="terms-para-section terms-white-text">
        <p className="terms-para-text">
          ...
          services, software and websites (the “Service”) provided by Myrl Tech,
          LLP. Dominate Ai (“Dominate”, “we”, “our”, etc.), and any data, text,
          ...
          applications, links, created tasks and associated information, text,
          files and other content or materials (together, the “Content”)
          uploaded, downloaded, or appearing on our websites or applications.
        </p>
        <br />
        <br />
        <p className="terms-para-text ">
          ...
          <span className="oauth-span-text">
            <a href="https://clickup.com/privacy" target="_blank">
              {" "}
              Privacy Policy
            </a>
          </span>
          &nbsp; explains the way we collect and use your information. By using
          the Service, you agree to be bound by these Terms and our Privacy
          Policy. If you’re using our Service on behalf of an organization or
          entity (“Organization”), then you are agreeing to these Terms on
          behalf of that Organization and you represent and warrant that you
          have the authority to bind the Organization to these Terms. In that
          case, “you” and “your” refers to that Organization.
        </p>
        <br />
        <br />
        <p className="terms-para-text ">
          Our Terms and Privacy Policy affect your legal rights and obligations.
          If you do not agree to be bound by all of these, do not access or use
          our Service.
        </p>
        <p className="terms-para-text ">
          ARBITRATION NOTICE: UNLESS YOU OPT-OUT AND EXCEPT FOR CERTAIN TYPES OF
        ...
        <ol className="terms-of-services-list">
          <li className="pt-0">
            <p className="terms-para-text">
              You must provide accurate information when you create your
              Dominate account.
            </p>
          </li>
          <li className="pt-0">
          ...
          <li className="pt-0">
            <p className="terms-para-text">
              You may not disassemble, decompile, or reverse engineer the
              Service or attempt or assist anyone else to do so, unless such
          ...
          <li className="pt-0">
            <p className="terms-para-text">
              ...
              except as required by law or in the event that you cancel your
              account during the 30-day money back guarantee period. You will
              pay all applicable fees when due and, if such fees are being paid
              via credit card or other electronic means, you authorize us to
              charge such fees using your selected payment method. By default,
              customer accounts are set to auto-renew and we may automatically
              charge you for such renewal on or after the renewal date
              associated with your account unless you have cancelled the Service
              prior to its renewal date. We may revise fee rates for the Service
              from time to time and will provide you with email notice of any
              changes in fees at least thirty (30) days prior to your Service
              renewal date. You are responsible for providing complete and
              accurate billing information to Dominate. We may suspend or
              terminate your use of the Service if fees become past due. You are
              responsible for all taxes (excluding taxes on our net income), and
              we will charge tax if required to do so by law.
              <br />
              <br />
              If you require the use of a purchase order or purchase order
              number, you (a) must provide the purchase order number at the time
              of purchase; and (b) agree that any terms and conditions on your
              purchase order will not apply and are null and void.
            </p>
          </li>
          <li className="pt-0">
            <p className="terms-para-text ">
              For paid accounts, we provide a <b>satisfaction guarantee</b> for
              all services. If you aren't satisfied for <b>any </b>reason,
              simply contact us within 30 days, and we'll be happy to issue a
              full refund. Kindly note, however, that we reserve the right to
              revoke refund privileges (on an individual basis) if we determine
              abuse of this policy has occurred.
            </p>
          </li>
        </ol>
        <p className="privacy-section-subtitle privacy-section-subtitle--terms-of-services">
        ...
        <ol className="terms-of-services-list">
          ...
          <li>
            ...
            alter or interfere with the way any our page is rendered or
          ...
          <li>
            ...
            these Terms or any of our other terms.
          </li>
          <li>
            ...
            Software may update automatically and if such Software is designed
            for use on a specific mobile or desktop operating system, then a
            compatible system is required for use. So long as you comply with
            ...
            provided, however, that this license does not constitute a sale of
            the Software or any copy thereof, and as between you and us, we
            retain all right, title and interest in the Software. You agree that
            you will not copy, reproduce, republish, frame, download, transmit,
            ...
            or any related software, except as expressly stated in these Terms.
          </li>
          <li>
            ...
            investigate and prosecute violations of any of these Terms to the
            ...
            You acknowledge that we have no obligation to prescreen or monitor
            your access to or use of our Service or any information, materials
            or other content provided or made available through our Service, but
            has the right to do so. You hereby agree that we may, in the
            exercise of our sole discretion, remove or delete any data, accounts
            or other content that violates these Terms or that is otherwise
            objectionable.
          </li>
          <li>
        ...
        <ol className="terms-of-services-list">
          <li className="pt-0">
            ...
            you for any reason, including, but not limited to, if we reasonably
            believe: (i) you have violated these Terms, (ii) you create risk or
            possible legal exposure for us; (iii) you have a free account that
            has not had any activity (replies or logins) for sixty (60) days, or
            trial accounts without a payment method thirty (30) days after
            expiration, or (iv) our provision of our Services to you is no
            longer commercially viable. We will make reasonable efforts to
            notify you through our Service, the next time you attempt to access
            your account, or by an email address or phone number you have
            provided us (if applicable). If we terminate your access to the
            Service, your Content and all other data will no longer be
          ...
          <li>
            ...
            Unless we make a change for legal or administrative reasons, we will
            provide reasonable advance notice before the Updated Terms become
            effective. You agree that we may notify you of the Updated Terms by
            posting them on the Service, and that your use of the Service after
            the effective date of the Updated Terms (or engaging in such other
            conduct as we may reasonably specify) constitutes your agreement to
            the Updated Terms. Therefore, you should review these Terms and any
            Updated Terms before using the Service. The Updated Terms will be
            ...
            disputes arising before the effective date of the{" "}
            <span className="oauth-span-text">
              <a href="https://clickup.com/terms#cmnt1" target="_blank">
                {" "}
                Updated Terms.
              </a>
            </span>
          ...
          <li>
            ...
            asking you for further information and/or documentation about your
            account usage or identity, or requiring you to take steps to confirm
            ownership of your email address, wireless/cellular telephone number
            or financial instruments, and verifying your information against
            third party databases or through other sources. This process is for
            internal verification purposes. You further understand that we may
            charge a fee for this verification process.
          </li>
          <li>
          ...
          <li>
            ...
            normal business operation of your use of the Services. You may
            opt-out of receiving text (SMS) messages from us at any time by
            texting the word STOP to (650) 203-2403 from the mobile device
          ...
          <li>
            ...
            result of standard search engine protocols or technologies used by a
            search engine with our express consent).
          </li>
          <li>
            ...
            problem. When you contact our support team, it is implied that you
            are allowing us to access your account if necessary, in order to be
            helpful. If you wish to receive assistance without granting
            permission to your account, please specify as much in your
            communication with our support team and those requests will be
          ...
          <li>
            ...
            which we or our agents maintain facilities. By using the Service,
            you consent to this transfer, processing and storage of your
            Content.
          </li>
        </ol>
        <p className="privacy-section-subtitle privacy-section-subtitle--terms-of-services">
        ...
        <ol className="terms-of-services-list pt-20">
          <li className="pt-0">
            <b>Ownership.</b> For purposes of these Terms: (i) "Content" means
            any data, text, files, information, usernames, images, graphics,
            photos, profiles, audio and video clips, sounds, musical works,
            works of authorship, applications, links, created tasks and
            associated information, text, files and other content or materials;
            and (ii) "User Content" means any Content that Account holders
            ...
            <p className="pt-40">
              ...
              <br /> Unless otherwise stated, all materials contained on or
              within the Services, including, but not limited to, text,
              graphics, images, code, illustrations, designs, icons,
              photographs, video clips, and written and other materials
              (collectively, "Dominate Content"), as well as their selection and
              arrangement, are protected by copyright, trademark, trade dress,
              patent, and/or other intellectual property laws, and unauthorized
              use of Dominate Content may violate such laws and these Terms.
              Except as expressly provided in these Terms, we do not grant any
              express or implied rights to use Dominate Content. You agree that
              you will not copy, reproduce, republish, frame, download,
              transmit, modify, display, reverse engineer, sell, or participate
              in any sale of, rent, lease, loan, assign, distribute, license,
              sublicense, or exploit in any way, in whole or in part, Dominate
              Content, the Services or any related software or Client Software
              as defined above, except as expressly stated in these Terms. You
              ...
              or accompanying the Services or Content. You acknowledge that the
            ...
            <p className="pt-40">
              ...
              exclusively by you in your Dominate Service account. Any Content
              that is yours remains yours. These Terms of Service do not grant
              us any licenses or rights to your Content except for the limited
              rights needed for us to provide the Dominate Service to you.
              Notwithstanding the foregoing, we may access Content to determine
              how we can improve our Service, and to determine customer
              satisfaction.
              <br />
              Similarly, any reporting data we collect from your use of the
              Dominate Service remains yours. By using the Dominate Service you
              agree that we can use this data to provide the Dominate Service to
              you, and you also agree that as long as the data is anonymized and
              does not identify you, we can combine this data with the
              anonymized data of other companies to provide benchmarking, public
              reports or to otherwise use it to provide the Dominate Service.
            </p>
            <p className="pt-40">
              c.<b> Alerts and Notification</b>
              <br />
              As part of the Services we provide, you may (if enabled) receive
              push notifications, text messages, alerts, emails, or other types
              of messages directly sent to you outside or inside the App
              ("Notifications"). You have control over the Notifications
              settings, and can opt in or out of these Notifications through the
              Services (with the possible exception of infrequent, important
          ...
          <li>
            The Dominate and Myrl Technologies, Inc. name and logo are our
            trademarks, and may not be copied, imitated or used, in whole or in
            part, without our prior written permission. In addition, all page
            headers, custom graphics, button icons, and scripts are our service
            marks, trademarks, and/or trade dress, and may not be copied,
          ...
          <li>
            ...
            <p className="pt-40 pl-100">
              d. The distribution, public performance, or public display of Our
              Content;
            </p>
            <p className="pt-40 pl-100">
              e. Modifying or otherwise making any derivative uses of the
              Services or Our Content, or any portion thereof;
            </p>
            <p className="pt-40 pl-100">
              f. Use of any scraping, data mining, robots, or similar data
              gathering or extraction methods;
            </p>
            <p className="pt-40 pl-100">
              g. Downloading (other than page caching) any portion of the
              Services, Our Content, or any information contained therein,
              except as expressly permitted on the Services;
            </p>
            <p className="pt-40 pl-100">
              h. Accessing our API with an unauthorized or third-party client;
              and
            </p>
            <p className="pt-40 pl-100">
              i. Any use of the Services or Our Content other than for their
              intended purposes.
            </p>
            <p className="pt-40 pl-100">
              j. Any use of the Services or Our Content other than as
              ...
              to use our Service and Site granted in these Terms.
            </p>
          </li>
          <li>
            ...
            specifically requested and to which certain specific terms,
            conditions and requirements may apply. This is to avoid any
            misunderstandings if your ideas are similar to those we have
            developed or are developing independently. If, despite our policy,
            you choose to send us content, information, ideas, suggestions, or
            other materials, you further agree to the following:
            <br />
            <br />
            For all reviews, comments, feedback, postcards, suggestions, ideas,
            and other submissions disclosed, submitted, or offered to us via our
            Service, our sites, by e-mail or telephone, by mail, or otherwise
            disclosed, submitted or offered in connection with your use of this
            Service (collectively, “User Submissions”) you grant us a
            royalty-free, irrevocable, transferable right and license to use the
            User Submissions however we desire, including without limitation, to
            copy, modify, delete in its entirety, adapt, publish, translate,
            create derivative works from, and/or sell and/or distribute such
            User Submissions and/or incorporate such User Submissions into any
            form, medium, or technology throughout the world.
            <br />
            We will be entitled to use, reproduce, disclose, modify, adapt,
            create derivative works from, publish, display, and distribute any
            User Submissions you submit for any purpose whatsoever, without
            restriction and without compensating you in any way. We are and
            shall be under no obligation (1) to maintain any User Submissions in
            confidence; (2) to pay to user any compensation for any User
            Submissions; or (3) to respond to any User Submissions. You agree
            that any User Submissions submitted by you to us will not violate
            the right of any third party, including without limitation,
            ...
            further agree that no User Submissions submitted by you to us will
            be or contain libelous or otherwise unlawful, threatening, abusive
        ...
        <p className="terms-para-text pt-20">
          ...
          ("DMCA"). If you believe your work has been copied in a way that
          constitutes copyright infringement, please provide a notice containing
          all of the following information to our &nbsp;{" "}
          <span className="oauth-span-text">
            <a href="https://clickup.com/terms#cmnt3" target="_blank">
              Copyright Agent
            </a>
          </span>
        </p>
        <ul className="terms-para-text pl-100 pt-60">
          <li>
        ...
        <p className="terms-para-text">
          ...
          <br />
          <br /> Our Copyright Agent for Notice of claims of copyright
          infringement on the Site is Chase Neely, who can be reached as
          follows:
          <a href="mailto:platform@dominate.com"> platform@dominate.com</a>
        </p>
        <p className="privacy-section-subtitle privacy-section-subtitle--terms-of-services">
        ...
        <p className="terms-para-text pt-20">
          ...
          AGENTS (COLLECTIVELY, THE "DOMINATE PARTIES") MAKE ANY REPRESENTATIONS
          OR WARRANTIES OR ENDORSEMENTS OF ANY KIND WHATSOEVER, EXPRESS OR
          IMPLIED, AS TO: (A) THE SERVICE; (B) OUR CONTENT; (C) USER CONTENT; OR
          (D) SECURITY ASSOCIATED WITH THE TRANSMISSION OF INFORMATION TO US OR
          VIA THE SERVICE. IN ADDITION, THE DOMINATE PARTIES HEREBY DISCLAIM ALL
          WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, THE
          WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE,
          NON-INFRINGEMENT, TITLE, CUSTOM, TRADE, QUIET ENJOYMENT, SYSTEM
          INTEGRATION, AND FREEDOM FROM COMPUTER VIRUS. THE DOMINATE PARTIES DO
          NOT REPRESENT OR WARRANT THAT THE SERVICE WILL BE ERROR-FREE OR
          ...
          COMPONENTS, INCLUDING, WITHOUT LIMITATION, VIRUSES AND SECURITY
          BREACHES OF ANY KIND. THE DOMINATE PARTIES DO NOT MAKE ANY
          ...
          DOMINATE PARTIES DO NOT WARRANT THAT YOUR USE OF THE SERVICE IS LAWFUL
          IN ANY PARTICULAR JURISDICTION, AND THE DOMINATE PARTIES SPECIFICALLY
          ...
          <br />
          <br />
          THE DOMINATE PARTIES DO NOT ENDORSE CONTENT AND SPECIFICALLY DISCLAIM
        ...
        <p className="terms-para-text pt-20">
          UNDER NO CIRCUMSTANCES WILL THE DOMINATE PARTIES BE LIABLE TO YOU FOR
          ...
          INDIRECTLY RELATED TO: (A) THE SERVICE; (B) OUR CONTENT; (C) USER
          ...
          THE DOMINATE PARTIES OR LAW ENFORCEMENT AUTHORITIES REGARDING YOUR OR
          ANY OTHER PARTY'S USE OF THE SERVICE; (F) ANY ACTION TAKEN IN
          CONNECTION WITH COPYRIGHT OR OTHER INTELLECTUAL PROPERTY OWNERS; (G)
          ANY ERRORS OR OMISSIONS IN THE SERVICE'S OPERATION; OR (H) ANY DAMAGE
          TO ANY USER'S COMPUTER, MOBILE DEVICE, OR OTHER EQUIPMENT OR
          TECHNOLOGY INCLUDING, WITHOUT LIMITATION, DAMAGE FROM ANY SECURITY
          ...
          DOMINATE PARTIES HAVE BEEN ADVISED OF OR SHOULD HAVE KNOWN OF THE
          ...
          IN NO EVENT WILL THE DOMINATE PARTIES BE LIABLE TO YOU OR ANYONE ELSE
          ...
          EXCLUSION MAY NOT APPLY TO YOU. IN NO EVENT WILL THE DOMINATE PARTIES
          ...
          PROPERTY, PRODUCT, OR OTHER CONTENT OWNED OR CONTROLLED BY THE
          DOMINATE PARTIES, AND YOU WILL HAVE NO RIGHTS TO ENJOIN OR RESTRAIN
          ...
          CONTENT OWNED OR CONTROLLED BY THE DOMINATE PARTIES.
          <br />
          <br />
          <br />
          ...
          WITH THE DEBTOR." WE ARE NOT RESPONSIBLE FOR THE ACTIONS, CONTENT,
          INFORMATION, OR DATA OF THIRD PARTIES, AND YOU RELEASE THE DOMINATE
          PARTIES FROM ANY CLAIMS AND DAMAGES, KNOWN AND UNKNOWN, ARISING OUT OF
        ...
        <p className="terms-para-text pt-20">
          ...
          and hold the Dominate Parties harmless from and against any claims,
        ...
        <ul className="terms-para-text pl-100 pt-60">
          <li>(i) your Content or your access to or use of the Service;</li>
          <li className="pt-20">
          ...
          <li className="pt-20">(v) any misrepresentation made by you.</li>
        </ul>
        <p className="terms-para-text pt-60">
        ...
        <p className="terms-para-text pt-20">
          ...
          <br />
          Myrl Technologies, Inc.
          <br />
          <br />
          ATTN: Privacy Agent Dominate
          <br />
          <br />
        ...
        <p className="terms-para-text pt-20">
          ...
          located in San Diego, CA, and to submit to the personal jurisdiction
          of the courts located in San Diego County for the purpose of
        ...
        <p className="terms-para-text pt-20">
          ...
          any prior agreements between you and us. You will not assign the Terms
          or assign any rights or delegate any obligations hereunder, in whole
          or in part, whether voluntarily or by operation of law, without our
          prior written consent. Any purported assignment or delegation by you
          without our appropriate prior written consent will be null and void.
          We may assign these Terms or any rights hereunder without your consent
          and the Terms will inure to the benefit of and be enforceable by our
          successor. Neither the course of conduct between the parties nor trade
          practice will act to modify the Terms. These Terms do not confer any
      ...
      <div className="background-section--terms1">
        ...
        <div className="terms-section terms-section--terms-of-services">
          <div className="privacy-title-section">
            <PageTitle text={"Terms Of Services"} />
          </div>
          {renderBlockOne()}
        </div>
        <LandingPageFooter />
...
export default LandingPageTermsOfServices;
