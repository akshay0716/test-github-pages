...
export class LandingPageComparisonProspect extends Component {
  componentDidMount() {
    window.scrollTo(0, 0);
  }
  renderBlock1 = () => {
      ...
      <div className="comprison-content-para">
        <div className="row flex-nowrap justify-content-between mx-1 align-items-start">
          ...
          <p className="comparison-para pl-3">
            ...
            sales and marketing professionals to easily build reach out lists.
            The main focus of prospect.io is on data gathering, lead enrichment
            and list building and caters to marketing as well as sales teams.
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="background-section background-section--comparison">
        ...
        <div className="comparsion-title-section">
          <h2 className="comparison-title">Dominate &amp; Prospect.Io</h2>
...
export default LandingPageComparisonProspect;
