...
export class LandingPageComparisonEasyLeadz extends Component {
  componentDidMount() {
    window.scrollTo(0, 0);
  }
      ...
      <div className="comprison-content-para">
        <div className="row justify-content-between mx-1 flex-nowrap align-items-start">
          ...
          <p className="comparison-para pl-3">
            ...
            that provides an interface and dashboard similar to the linkedin
            sales navigator and helps sales people and marketers to build email
            lists. It also has a google chrome plugin that helps to scrape on
            the pages that you surf over the internet.{" "}
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="background-section background-section--comparison">
        ...
        <div className="comparsion-title-section">
          <h2 className="comparison-title">Dominate &amp; EasyLeadz</h2>
...
export default LandingPageComparisonEasyLeadz;
