...
export class LandingPageComparisonCopper extends Component {
  componentDidMount() {
    window.scrollTo(0, 0);
  }
      ...
      <div className="comprison-content-para">
        <div className="row justify-content-between mx-1 align-items-start flex-nowrap">
          ...
          <p className="comparison-para pl-3">
            ...
            almost lives inside gmail. It is lightweight and similar to Nimble
            CRM and helps salespeople keep track of important details such as
    ...
    return (
      <div className="background-section background-section--comparison">
        ...
        <div className="comparsion-title-section">
          <h2 className="comparison-title">Dominate &amp; Copper CRM</h2>
...
export default LandingPageComparisonCopper;
