...
export class LandingPageComparisonZoho extends Component {
  componentDidMount() {
    window.scrollTo(0, 0);
  }
  renderBlock1 = () => {
      ...
      <div className="comprison-content-para">
        <div className="row flex-nowrap justify-content-between mx-1 align-items-start">
          ...
          <p className="comparison-para pl-3">
            ...
            track leads, deals, relationships and analyze sales data in
            real-time.
          </p>
        </div>
      </div>
    ...
    return (
      <div className="background-section background-section--comparison">
        ...
        <div className="comparsion-title-section">
          <h2 className="comparison-title">Dominate &amp; Zoho CRM</h2>
...
export default LandingPageComparisonZoho;
