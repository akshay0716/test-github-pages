...
export class LandingPageComparisonFreshsales extends Component {
  componentDidMount() {
    window.scrollTo(0, 0);
  }
  /*============================================
    ...
    return (
      <div className="background-section background-section--comparison">
        ...
        <div className="comparsion-title-section">
          <h2 className="comparison-title">Dominate &amp; Freshsales</h2>
...
export default LandingPageComparisonFreshsales;
