...
export class LandingPageComparisonSalesflare extends Component {
  componentDidMount() {
    window.scrollTo(0, 0);
  }
  renderBlock1 = () => {
      ...
      <div className="comprison-content-para">
        <div className="row flex-nowrap justify-content-between mx-1 align-items-start">
          ...
          <p className="comparison-para pl-3">
            Salesflare is a feature-rich traditional CRM that provides
    ...
    return (
      <div className="background-section background-section--comparison">
        ...
        <div className="comparsion-title-section">
          <h2 className="comparison-title">Dominate &amp; Salesflare</h2>
...
export default LandingPageComparisonSalesflare;
