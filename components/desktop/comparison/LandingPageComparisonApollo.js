...
const list2 = [
  "While Apollo provides great amounts of data and insights into your leads, it lacks the ability to track those leads.",
...
export class LandingPageComparisonApollo extends Component {
  componentDidMount() {
    window.scrollTo(0, 0);
  }
      ...
      <div className="comprison-content-para">
        <div className="row justify-content-between mx-1 align-items-start flex-nowrap">
          ...
          <p className="comparison-para pl-3">
            Apollo.io uses big data to provide leads that have a higher
            conversion rate. It also enriches your existing leads with the help
            of data signals. It is a data-first engagement platform.
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="background-section background-section--comparison">
        ...
        <div className="comparsion-title-section">
          <h2 className="comparison-title">Dominate &amp; Apollo.io</h2>
...
export default LandingPageComparisonApollo;
